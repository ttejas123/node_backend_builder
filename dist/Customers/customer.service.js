...
var customerService = /** @class */ (function () {
    ...
    customerService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.repository.create(data)];
            });
        });
    };
    customerService.prototype.read = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Implement business logic
                return [2 /*return*/, this.repository.read(id)];
            });
        });
    };
    customerService.prototype.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // Implement business logic
                return [2 /*return*/, this.repository.update(id, data)];
            });
        });
    };
